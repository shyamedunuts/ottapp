...
import com.dignalott.di.AppModule_ProvideMovieRepositoryFactory;
import com.dignalott.repository.MovieRepository;
import com.dignalott.viewmodels.MainViewModel;
import com.dignalott.viewmodels.MainViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMovieApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MovieApplication_HiltComponents.ActivityC {
    ...
    @Override
    public void injectMovieActivity(MovieActivity arg0) {
    }
  ...
  private static final class ViewModelCImpl extends MovieApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.dignalott.viewmodels.MainViewModel", ((Provider) mainViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.dignalott.viewmodels.MainViewModel 
  ...
  private static final class SingletonCImpl extends MovieApplication_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.dignalott.repository.MovieRepository 
          return (T) AppModule_ProvideMovieRepositoryFactory.provideMovieRepository();
